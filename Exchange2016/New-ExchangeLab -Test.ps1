...
if(Connect-ToAzureRm) {
  ...
  if($LabConfiguration -ne $null) {
    ...
    # Domain
    $DomaiName = $LabConfiguration.ActiveDirectory.Domain.DomainName
    $DomainNetBIOS = $LabConfiguration.ActiveDirectory.Domain.DomainNetBIOS
    $ForestMode = $LabConfiguration.ActiveDirectory.Domain.ForestMode
    $DomainMode = $LabConfiguration.ActiveDirectory.Domain.DomainMode
    $InstallDNS = $LabConfiguration.ActiveDirectory.Domain.InstallDNS
    $CreateDNSDelegation = $LabConfiguration.ActiveDirectory.Domain.CreateDNSDelegation
    $DatabasePath = $LabConfiguration.ActiveDirectory.Domain.DatabasePath
    $SysvolPath = $LabConfiguration.ActiveDirectory.Domain.SysvolPath
    $LogPath = $LabConfiguration.ActiveDirectory.Domain.LogPath
    ...
    #Install-ADDSForest -DomainName $DomainName -CreateDNSDelegation $CreateDNSDelegation -DomainMode $DomainMode -ForestMode $ForestModew -DatabasePath $DatabasePath -Sysvolpath $SysvolPath -LogPath $LogPath -InstallDNS -Force
  }  
